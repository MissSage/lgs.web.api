Dev Build:: 
  ...
  [![Front](https://img.shields.io/badge/Front-VUE-d.svg)](#) [![sdk](https://img.shields.io/badge/sdk-3.1-d.svg)](#)  [![Build status](https://github.com/anjoy8/lgs.web.api/workflows/.NET%20Core/badge.svg)](https://github.com/anjoy8/lgs.web.api/actions) [![codecov](https://codecov.io/gh/anjoy8/lgs.web.api/branch/master/graph/badge.svg)](https://codecov.io/gh/anjoy8/lgs.web.api)  [![License MIT](https://img.shields.io/badge/license-Apache-blue.svg?style=flat-square)](https://github.com/anjoy8/lgs.web.api/blob/master/LICENSE) [![Language](https://img.shields.io/badge/language-csharp-d.svg)](#) 
[![star this repo](http://githubbadges.com/star.svg?user=anjoy8&repo=lgs.web.api&style=flat)](https://github.com/boennemann/badges) 
[![fork this repo](http://githubbadges.com/fork.svg?user=anjoy8&repo=lgs.web.api&style=flat)](https://github.com/boennemann/badges/fork) 
...
BCVP（lgs.web.api&Vue Project）开箱即用的企业级前后端分离【 .NET Core3.1 Api + Vue 2.x + RBAC】权限框架。 
...
- [x] 封装`lgs.web.api.Webapi.Template`项目模板，一键重建自己的项目 ✨；
...
![系统架构图](http://apk.neters.club/lgs.web.api.System.Architecture.png)
...
数据查看：[lgs.web.api.Data.json](https://github.com/anjoy8/Blog.Data.Share/tree/master/BlogCore.Data.json)
...
| ------- | -------- | ------- |
| [lgs.web.api.Webapi.Template](https://www.nuget.org/packages/lgs.web.api.Webapi.Template/) | [![lgs.web.api.Webapi.Template](https://img.shields.io/nuget/v/lgs.web.api.Webapi.Template.svg)](https://www.nuget.org/packages/lgs.web.api.Webapi.Template/)  | [![lgs.web.api.Webapi.Template](https://img.shields.io/nuget/dt/lgs.web.api.Webapi.Template.svg)](https://www.nuget.org/packages/lgs.web.api.Webapi.Template/) |
...
|[NetCore-Sugar-Demo](https://github.com/anjoy8/NetCore-Sugar-Demo)|[Blog.SplRepository.Demo](https://github.com/anjoy8/Blog.SplRepository.Demo)|[lgs.web.api](https://github.com/anjoy8/lgs.web.api)|[ChristDDD](https://github.com/anjoy8/ChristDDD)|
