[ENGLISH](https://github.com/anjoy8/lgs.web.api/blob/master/README-en.md) | [中文版](https://github.com/anjoy8/lgs.web.api/blob/master/README.md)


![Logo](https://github.com/anjoy8/lgs.web.api/blob/master/lgs.web.api/wwwroot/logocore.png)
...
*********************************************************
# Tips: 
1. lgs.web.api.FrameWork project is a simple implementation of generating files using T4 templates.
...
1, in the lgs.web.api.Repository layer under the Sugar folder under the BaseDBConfig.cs, configure their own strings
``` 
...
```
2, in the lgs.web.api.FrameWork layer of the dbhelper.ttinclude, configure their own strings
``` 
...
Blog Park: https://www.cnblogs.com/laozhang-is-phi/
 ...
 Code Cloud: Https://gitee.com/laozhangIsPhi/lgs.web.api
