...
using lgs.web.api.Extensions;
using lgs.web.api.Filter;
using lgs.web.api.Hubs;
using lgs.web.api.IServices;
using lgs.web.api.Middlewares;
using lgs.web.api.Model.Seed;
using lgs.web.api.Tasks;
...
namespace lgs.web.api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, MyContext myContext, ITasksQzServices tasksQzServices, ISchedulerCenter schedulerCenter, IHostApplicationLifetime lifetime)
        {
            ...
            // 封装Swagger展示
            app.UseSwaggerMildd(() => GetType().GetTypeInfo().Assembly.GetManifestResourceStream("lgs.web.api.Api.index.html"));
